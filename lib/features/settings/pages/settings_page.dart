          ...
          body: ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                title: const Text('删除远端资料并清除本地备赛数据'),
                subtitle: const Text('请求后端删除收藏 / 历史 / 个人背景，并清除本机备赛数据与匿名凭证'),
                onTap: () {
                  Haptics.light();
              ...
              ListTile(
                ...
                subtitle: const Text(
                  '档案 / 收藏 / 历史 / 推荐 / 匹配 / 备赛请求均通过真实后端处理；备赛计划与提醒保存在本机。',
                ),
              ),
              const Divider(),
              const Padding(
  ...
  Future<void> _confirmClear(BuildContext context, WidgetRef ref) async {
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('删除远端资料并清除本地备赛数据'),
        content: const Text(
          '将请求后端删除当前身份下的收藏、历史与个人背景，并清除本机备赛计划、助手历史、诊断缓存与匿名凭证。是否继续？',
        ),
        actions: [
          TextButton(
            onPressed: () {
    ...
    try {
      ...
      await ref.read(apiAuthenticatorProvider).clear();
      await _clearLocalPreparationData(ref);
